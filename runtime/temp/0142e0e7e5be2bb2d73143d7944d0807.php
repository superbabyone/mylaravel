<?php /*a:5:{s:66:"D:\phpStudy\WWW\tp5.1\application\index\view\goods\goods_info.html";i:1555395720;s:56:"D:\phpStudy\WWW\tp5.1\application\index\view\layout.html";i:1556438421;s:63:"D:\phpStudy\WWW\tp5.1\application\index\view\public\header.html";i:1555985793;s:60:"D:\phpStudy\WWW\tp5.1\application\index\view\public\nav.html";i:1554775881;s:63:"D:\phpStudy\WWW\tp5.1\application\index\view\public\footer.html";i:1554288417;}*/ ?>
...
<div class="soubg">
        <div class="sou">
            ...
            <span class="fr">
                ...
                <?php else: ?>
                <span class="fl">欢迎<font style="color: red"><?php echo htmlentities(app('session')->get('sessionInfo')['u_email']); ?></font>登陆|&nbsp;<a href="<?php echo url('login/loginOut'); ?>">退出</a>|&nbsp;<a href="<?php echo url('user/userList'); ?>">我的收藏</a>&nbsp;|</span>
                <?php endif; ?>
                <span class="ss">
                    <div class="ss_list">
                        <a href="#">收藏夹</a>
...
<div class="menu_bg">
        <div class="menu">
            ...
            <div class="nav">
                ...
                <div class="<?php echo htmlentities($show); ?>">
                    <ul> 
                        <?php if(is_array($cateInfo) || $cateInfo instanceof \think\Collection || $cateInfo instanceof \think\Paginator): $k = 0; $__LIST__ = $cateInfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($k % 2 );++$k;$t = $k-1; ?>
                        <li>
                            <div class="fj">
                                <span class="n_img"><span></span><img src="/static/index/images/nav1.png" /></span>
                                <span class="fl"><?php echo htmlentities($v['cate_name']); ?></span>
                            </div>
                            <div class="zj" style="top:-<?php echo htmlentities($t*40); ?>px;">
                                <div class="zj_l">
            ...
            <ul class="menu_r">
                ...
                <li><a href="<?php echo url('goods/goodsList'); ?>?cate_id=<?php echo htmlentities($vo['cate_id']); ?>"><?php echo htmlentities($vo['cate_name']); ?></a></li>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </ul>
...
<div class="i_bg">
    ...
    <div class="content">
        ...
        <div id="tsShopContainer">
            <div id="tsImgS"><a href="/uploads/<?php echo htmlentities($goodsInfo['goods_img']); ?>" title="/static/index/images/" class="MagicZoom" id="MagicZoom"><img src="/uploads/<?php echo htmlentities($goodsInfo['goods_img']); ?>" width="390" height="390" /></a></div>
            <div id="tsPicContainer">
                <div id="tsImgSArrL" onclick="tsScrollArrLeft()"></div>
                <div id="tsImgSCon">
                    <ul>
                        <li onclick="showPic(0)" rel="MagicZoom" class="tsSelectImg"><img src="/static/index/images//ps1.jpg" tsImgS="/static/index/images//ps1.jpg" width="79" height="79" /></li>
                        <li onclick="showPic(1)" rel="MagicZoom"><img src="/static/index/images//ps2.jpg" tsImgS="/static/index/images//ps2.jpg" width="79" height="79" /></li>
                        <li onclick="showPic(2)" rel="MagicZoom"><img src="/static/index/images//ps3.jpg" tsImgS="/static/index/images//ps3.jpg" width="79" height="79" /></li>
                        <li onclick="showPic(3)" rel="MagicZoom"><img src="/static/index/images//ps4.jpg" tsImgS="/static/index/images//ps4.jpg" width="79" height="79" /></li>
                        <li onclick="showPic(4)" rel="MagicZoom"><img src="/static/index/images//ps1.jpg" tsImgS="/static/index/images//ps1.jpg" width="79" height="79" /></li>
                        <li onclick="showPic(5)" rel="MagicZoom"><img src="/static/index/images//ps2.jpg" tsImgS="/static/index/images//ps2.jpg" width="79" height="79" /></li>
                        <li onclick="showPic(6)" rel="MagicZoom"><img src="/static/index/images//ps3.jpg" tsImgS="/static/index/images//ps3.jpg" width="79" height="79" /></li>
                        <li onclick="showPic(7)" rel="MagicZoom"><img src="/static/index/images//ps4.jpg" tsImgS="/static/index/images//ps4.jpg" width="79" height="79" /></li>
                    </ul>
                </div>
        ...
        <div class="pro_des">
            ...
            <div class="des_price">
            	本店价格：<b><?php echo htmlentities($goodsInfo['shop_price']); ?></b><br />
                库存：<span><?php echo htmlentities($goodsInfo['goods_number']); ?></span>
            </div>
            ...
            <div class="des_join">
            	<div class="j_nums">
                    <input type="hidden" value="<?php echo htmlentities($goodsInfo['goods_id']); ?>" id="goods_id">
                    <input type="hidden" value="<?php echo htmlentities($goodsInfo['goods_number']); ?>" id="goods_num">
                	<input type="text" id="buy_num" value="1" class="n_ipt" />
                    <input type="button" id="add" class="n_btn_1" />
                    <input type="button" id="less" class="n_btn_2" />   
                </div>
                <span class="fl" id="b_car"><a><img src="/static/index/images//j_car.png" /></a></span>
            </div>            
        </div>    
    ...
    <div class="content mar_20">
        ...
        <div class="l_list">        	
            ...
            <div class="des_border" id="p_details">
                ...
                <div class="des_con">
                    <?php echo htmlentities($goodsInfo['description']); ?>
                </div>
          	</div>  
            <!-- 商品评论 -->
            <div class="des_border" id="p_comment">
                ...
                <table border="0" class="jud_tab" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td width="300">
                    	<table border="0" style="width:100%;" cellspacing="0" cellpadding="0">
                          <tr>
                            ...
                            <td><img src="/static/index/images//pl.gif" align="absmiddle" /></td>
                          </tr>
                          <tr>
                    ...
                    <td class="jud_bg">您可对已购买商品进行评价<br /><a href="#"><img src="/static/index/images//btn_jud.gif" /></a></td>
                  </tr>
                </table>
                ...
                <table border="0" class="jud_list" style="width:100%; margin-top:30px;" cellspacing="0" cellpadding="0">
                  <tr valign="top">
                    <td width="160"><img src="/static/index/images//peo1.jpg" width="20" height="20" align="absmiddle" />&nbsp;向死而生</td>
                    <td width="180">
                  ...
                  <tr valign="top">
                    <td width="160"><img src="/static/index/images//peo2.jpg" width="20" height="20" align="absmiddle" />&nbsp;就是这么想的</td>
                    <td width="180">
                    	颜色分类：<font color="#999999">粉色</font> <br />
                        型号：<font color="#999999">50ml</font>
                    </td>
                  ...
                  <tr valign="top">
                    <td width="160"><img src="/static/index/images//peo3.jpg" width="20" height="20" align="absmiddle" />&nbsp;墨镜墨镜</td>
                    <td width="180">
                    	颜色分类：<font color="#999999">粉色</font> <br />
                        型号：<font color="#999999">50ml</font>
                    </td>
                  ...
                  <tr valign="top">
                    <td width="160"><img src="/static/index/images//peo4.jpg" width="20" height="20" align="absmiddle" />&nbsp;那*****洋 <br /><font color="#999999">（匿名用户）</font></td>
                    <td width="180">
                    	颜色分类：<font color="#999999">粉色</font> <br />
                        型号：<font color="#999999">50ml</font>
                    </td>
    ...
    <div id="MyDiv" class="white_content">             
        <div class="white_d">
            ...
            <div class="notice_c">
                ...
                <table border="0" align="center" style="margin-top:10px; cursor:pointer;" cellspacing="0" cellpadding="0">
                  <tr valign="top">
    ...
    <script>
        layui.use(['layer'],function(){
            ...
            //点击购物车
            $(document).on('click','#b_car',function(){
                var goods_id = $('#goods_id').val();
                var buy_num = $('#buy_num').val();
                $.post(
                    "<?php echo url('car/addCar'); ?>",
