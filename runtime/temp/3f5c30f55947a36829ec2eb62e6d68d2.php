<?php /*a:5:{s:69:"D:\phpStudy\WWW\tp5.1\application\index\view\order\success_order.html";i:1556267903;s:56:"D:\phpStudy\WWW\tp5.1\application\index\view\layout.html";i:1556438421;s:63:"D:\phpStudy\WWW\tp5.1\application\index\view\public\header.html";i:1555985793;s:60:"D:\phpStudy\WWW\tp5.1\application\index\view\public\nav.html";i:1554775881;s:63:"D:\phpStudy\WWW\tp5.1\application\index\view\public\footer.html";i:1554288417;}*/ ?>
            ...
            <table border="0" style="width:1000px; text-align:center;" cellspacing="0" cellpadding="0">
              <tr height="35">
                <td style="font-size:18px;">
                	感谢您在本店购物！您的订单已提交成功，请记住您的订单号: <font color="#ff4e00"><?php echo htmlentities($orderInfo['order_no']); ?></font>
                </td>
              </tr>
              <tr>
                <td style="font-size:14px; font-family:'宋体'; padding:10px 0 20px 0; border-bottom:1px solid #b6b6b6;">
                  <?php if(($orderInfo['pay_type'] == 1)): ?>
                  您选定的支付方式为: <font color="red"><a href="<?php echo url('alipay'); ?>?order_id=<?php echo htmlentities($orderInfo['order_id']); ?>">支付宝</a></font>； &nbsp; &nbsp;您的应付款金额为: <font color="#ff4e00">￥<?php echo htmlentities($orderInfo['order_amount']); ?></font>
                  <?php elseif(($orderInfo['pay_type'] == 2)): ?>
                  您选定的支付方式为: <font color="#ff4e00">微信</font>； &nbsp; &nbsp;您的应付款金额为: <font color="#ff4e00">￥<?php echo htmlentities($orderInfo['order_amount']); ?></font>
                  <?php else: ?>
                  您选定的支付方式为: <font color="#ff4e00">余额支付</font>； &nbsp; &nbsp;您的应付款金额为: <font color="#ff4e00">￥<?php echo htmlentities($orderInfo['order_amount']); ?></font>
                  <?php endif; ?>
                </td>
              </tr>
              <tr>
                <td style="padding:20px 0 30px 0; font-family:'宋体';">
                	银行名称 收款人信息：全称 viya民生银行 ；帐号或地址 4541341234134 ；开户行 民生银行。 <br />
