<?php /*a:1:{s:61:"D:\phpStudy\WWW\tp5.1\application\index\view\login\login.html";i:1555506367;}*/ ?>
<!DOCTYPE html>
<html>
			...
			<div class="login-main">
				...
				<div class="login-box">
							...
							<div class="login-form">
								<form>
									<div class="user-name">
										...
										<input type="text" name="u_email" id="account" value="<?php echo htmlentities(app('cookie')->get('rememberInfo')['u_email']); ?>" placeholder="手机号/邮箱">
									</div>
									<div class="user-pass">
										<label for="user_pwd"><i class="am-icon-lock"></i></label>
										<input type="password" name="u_pwd" id="user_pwd" value="<?php echo htmlentities(app('cookie')->get('rememberInfo')['u_pwd']); ?>" placeholder="请输入密码">
									</div>
								</form>
							</div>
							...
							<div class="login-links">
								...
								<a href="<?php echo url('findPwd'); ?>" class="am-fr">忘记密码</a>
