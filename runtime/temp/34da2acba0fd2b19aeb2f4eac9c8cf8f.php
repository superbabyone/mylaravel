<?php /*a:6:{s:62:"D:\phpStudy\WWW\tp5.1\application\index\view\address\edit.html";i:1556021686;s:56:"D:\phpStudy\WWW\tp5.1\application\index\view\layout.html";i:1554708099;s:63:"D:\phpStudy\WWW\tp5.1\application\index\view\public\header.html";i:1555985793;s:65:"D:\phpStudy\WWW\tp5.1\application\index\view\public\user_top.html";i:1554295793;s:66:"D:\phpStudy\WWW\tp5.1\application\index\view\public\user_left.html";i:1554296088;s:63:"D:\phpStudy\WWW\tp5.1\application\index\view\public\footer.html";i:1554288417;}*/ ?>
...
<div class="m_top_bg">
        ...
        <div class="m_right">
            ...
            <table border="0" class="add_tab" style="width:930px;"  cellspacing="0" cellpadding="0">
                  ...
                  <td colspan="3" style="font-family:'宋体';">
                      <select class="changearea" id="province">
                        ...
                        <?php if(is_array($provinceInfo) || $provinceInfo instanceof \think\Collection || $provinceInfo instanceof \think\Paginator): $i = 0; $__LIST__ = $provinceInfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                            <option value="<?php echo htmlentities($v['id']); ?>" <?php if(($addressInfo['province'] == $v['id'])): ?> selected <?php endif; ?>><?php echo htmlentities($v['name']); ?></option>
                      ...
                      <select class="changearea" id="city">
                        ...
                        <option value="<?php echo htmlentities($v['id']); ?>" <?php if(($addressInfo['city'] == $v['id'])): ?> selected<?php endif; ?>><?php echo htmlentities($v['name']); ?></option>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                      </select>
                      <select class="changearea" id="area">
                        ...
                        <option value="<?php echo htmlentities($v['id']); ?>" <?php if(($addressInfo['area'] == $v['id'])): ?> selected<?php endif; ?>><?php echo htmlentities($v['name']); ?></option>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                      </select>
                      （必填）
                  </td>
                ...
                <tr>
                    <input type="hidden" value="<?php echo htmlentities($addressInfo['address_id']); ?>" id="address_id">
                  <td align="right">收货人姓名</td>
                  <td style="font-family:'宋体';"><input type="text" value="<?php echo htmlentities($addressInfo['address_name']); ?>" class="add_ipt" id="address_name" />（必填）</td>
                  <td align="right">联系方式</td>
                  <td style="font-family:'宋体';"><input type="text" value="<?php echo htmlentities($addressInfo['address_tel']); ?>" class="add_ipt" id="address_tel"/>（必填）</td>
                </tr>
                <tr>
                  <td align="right">详细地址</td>
                  <td style="font-family:'宋体';"><input type="text" value="<?php echo htmlentities($addressInfo['address_detail']); ?>" class="add_ipt" id="address_detail"/>（必填）</td>
                  <td align="right">邮政编码</td>
                  <td style="font-family:'宋体';"><input type="text" value="<?php echo htmlentities($addressInfo['address_mail']); ?>" class="add_ipt" id="address_mail"/></td>
                </tr>
                <tr>
      ...
      <script>
        layui.use(['layer'],function(){
          ...
          $('.edit').click(function(){
            var _this = $(this);
            var address_id = _this.parent('p').siblings("table[class=add_t]").attr('address_id');
            window.location.href="<?php echo url('Address/edit'); ?>?address_id="+address_id;
          })
        })
      </script>
